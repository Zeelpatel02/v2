        ...
        <div className="row">
          <div className="col-6">
            <div className="col-text">
              <div id="home-main">
                <h1>
                  Don't Be <b className="hover-red">Shy!</b>
                </h1>
                <p>
                  Although I’m currently trying to find any new opportunities,
                  my inbox is usually open. Whether you've got an issue or
                  simply want to mention hi, I’ll try my best to urge back to
                  you!
                </p>
              </div>
            </div>
